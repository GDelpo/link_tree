...
const INSTAGRAM_PROFILE_URL =
  profileData.socials?.find((social) => social.name === 'Instagram')?.url ||
    ...
    <div>
      ...
      {error && (
        <p className='text-center text-red-500'>
          Error al cargar posts de Instagram: {error.message}
        </p>
      )}
      {instagramPosts.length > 0 && <InstagramGrid items={instagramPosts} />}
