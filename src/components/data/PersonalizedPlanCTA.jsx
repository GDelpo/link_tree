...
const PersonalizedPlanCTA = ({ ctaData, contactLink, className = '' }) => {
  ...
  return (
    <div
      className={`relative w-full rounded-xl shadow-lg shadow-sky-900/10 dark:shadow-2xl dark:shadow-sky-800/20 p-6 text-center overflow-hidden ${className}`}
    >
