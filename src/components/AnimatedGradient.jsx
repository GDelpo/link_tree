...
import { SKY_GRADIENT_CLASSES, EMERALD_GRADIENT_CLASSES } from '@/utils/constants';
...
const AnimatedGradient = ({ 
  ...
  const baseClasses = 'absolute inset-0 bg-gradient-to-br animate-[gradient-x_4s_ease_infinite] transition-transform duration-300 group-hover:scale-110';
