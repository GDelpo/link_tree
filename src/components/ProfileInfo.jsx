...
const ProfileInfo = ({ name, titles, description }) => {
  ...
  return (
    <>
      <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold mb-3 tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-slate-900 to-sky-700 dark:from-white dark:to-sky-400">
        {name}
      </h1>
