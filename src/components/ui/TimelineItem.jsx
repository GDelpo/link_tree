...
const TimelineItem = ({ date, title, subtitle }) => {
  return (
    <article role="listitem" className="relative pl-8 sm:pl-12 py-4 group">
      ...
      <div className="flex flex-col items-center w-8 sm:w-12 absolute left-0 top-0 h-full" aria-hidden="true">
      ...
      <div className="bg-slate-100 dark:bg-slate-800/50 p-4 rounded-lg">
        <time className="text-xs uppercase font-semibold text-slate-500 dark:text-slate-400 mb-1" dateTime={date}>
          {date}
        </time>
