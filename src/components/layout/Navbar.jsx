 ...
 */
const NavLinksList = memo(
  ({ links, onLinkClick, activeSection, isMobile = false }) => {
...
const Navbar = memo(({ navLinks = [], activeSection }) => {
  ...
  return (
    <header
      className='sticky top-0 z-50 w-full backdrop-blur-lg bg-white/80 dark:bg-slate-900/80 border-b border-slate-200/50 dark:border-slate-700/50 transition-colors duration-300'
      role='banner'
    >
      <nav
        className='container mx-auto px-4 h-16 flex justify-between items-center relative'
        role='navigation'
      ...
      >
        ...
        <div className='flex items-center gap-4'>
          ...
          <div className='sm:hidden'>
            {' '}
            {/* Contenedor del botón de menú móvil */}
            <button
              ref={menuButtonRef}
